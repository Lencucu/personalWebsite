...
import WindScatterTriangles from "~/component/3d/windScatter";
...
export default function Page() {
  ...
  return (
    <div>
      <section
        className={`border-1 border-black max-w-md mx-auto bg-white shadow-md rounded-2xl p-6 flex flex-col items-center space-y-4`}
      ...
      {trigger && (
        <WindScatterTriangles
          targetId='aboutMe_page'
          trigger={trigger}
          onEnd={() => {setTrigger(false)}}
        />
      )}
    </div>
  );
