import { buildPiecewiseFunction, integratePiecewiseAsFunctions/*, integratePiecewise, evaluatePiecewise*/, evaluatePiecewiseFunctions } from './buildPiecewiseFunction';
...
export const integralLine1Function = integratePiecewiseAsFunctions([0,1],line1);
...
export const integralLine2Function = integratePiecewiseAsFunctions([0,1],line2);
...
export const integralLine3Function = integratePiecewiseAsFunctions([0,1],line3);
...
export const integralLine4Function = integratePiecewiseAsFunctions([0,1],line4);
...
export const integralLine5_1Function = integratePiecewiseAsFunctions([0,1],line5_1);
...
export function line1Ease(t: number): number {
  return evaluatePiecewiseFunctions(integralLine2Function, t);
}

export function line2Ease(t: number): number {
  return evaluatePiecewiseFunctions(integralLine3Function, t);
}

export function line3Ease(t: number): number {
  return evaluatePiecewiseFunctions(integralLine4Function, t);
}